...
public class AuthController {
	...
	public ResponseEntity<String> generateJwt(@Valid @RequestBody AuthenticationRequest request){
		...
		// authenticating the User data and Password
		try {
	...
	// validate - for every request it validates the user-credentials from the provided Jwt token in Authorization Request header
